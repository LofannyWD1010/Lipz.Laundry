...
public class JadwalPenyerahan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadwal_penyerahan);
                ...
                switch (groupPosition) {
                    case 0:
                        switch (childPosition) {
                            case 0:
                                Toast.makeText(JadwalPenyerahan.this, "Pukul 10.00",
                                        Toast.LENGTH_SHORT).show();
                                break;
                            case 1:
                                Toast.makeText(JadwalPenyerahan.this, "Pukul 14.00",
                                        Toast.LENGTH_SHORT).show();
                                break;
                            case 2:
                                Toast.makeText(JadwalPenyerahan.this, "Pukul 20.00",
                                        Toast.LENGTH_SHORT).show();
                                break;
                            default:
                                break;
    ...
    public void jadwalpenyerahan_ok(View view) {
